  ...
  return (
    ...
    >
      <div className="absolute top-2 right-2 z-10 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <button
          onClick={onRemove}
          className="bg-white p-2 rounded-lg shadow-md hover:shadow-lg transition-shadow text-red-500"
        >
        ...
        <div
          {...attributes}
          {...listeners}
          className="bg-white p-2 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-move"
        >
  ...
  return (
    <>
      <div className="flex-1 bg-gray-100 overflow-auto">
        <div className="min-h-full bg-white m-4 rounded-lg shadow-lg">
          {sections.length === 0 ? (
            <div className="flex items-center justify-center h-96 text-gray-400">
              <div className="text-center">
                <p className="text-xl mb-2">No sections yet</p>
                <p>Click on a section from the library to start building</p>
              </div>
            </div>
          ) : (
            <DndContext
